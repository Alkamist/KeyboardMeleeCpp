...
class BStick : public AnalogStick
{
public:
    void update(const bool& shield, const bool& neutral, const bool& left, const bool& right, const bool& down, const bool& up);
